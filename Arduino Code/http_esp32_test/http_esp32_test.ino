...
const char* ssid = "LFII";
const char* password =  "AsecreTshh";
 
void setup() {
  FastLED.addLeds<WS2811,18, BRG>(leds, NUM_LEDS);
  Serial.begin(115200);
  delay(4000);
...
void loop() {
  ...
  if ((WiFi.status() == WL_CONNECTED)) { //Check the current connection status
    ...
    http.begin("http://192.168.0.11:5000/get_strip_status/1233/"); //Specify the URL
